...
@Module({
  ...
  controllers: [TempatMagangController, PenempatanController, AbsensiMagangController, LaporDiriMagangController],
  providers: [TempatMagangService, PenempatanService, AbsensiMagangService, LaporDiriMagangService],
})
