...
export async function GET() {
  ...
  try {
    backendRes = await fetch(`${BACKEND}/api/ujian-ukk/submisi/export-excel`, {
  ...
  headers.set("Content-Disposition", disposition ?? "attachment; filename=\"Rekap_Submisi_UKK.xlsx\"");
