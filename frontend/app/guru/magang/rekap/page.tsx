...
const CARDS = [
  {
    href: "/guru/magang/rekap/lapor-diri",
    label: "Lapor Diri",
    desc: "Pantau laporan bulanan (PDF/PPT) siswa bimbingan Anda",
    color: "#0082FB",
    icon: FileUp,
  },
  {
    href: "/guru/magang/rekap/laporan",
    label: "Laporan",
    desc: "Rekap kehadiran siswa bimbingan dan unduh laporannya ke PDF/Excel",
    color: "#8A9E1F",
    icon: BarChart3,
  },
] as const;

export default function GuruMagangRekapHubPage() {
  return (
      ...
      <div className="relative overflow-hidden rounded-2xl p-6" style={{ background: "#0082FB" }}>
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="text-2xl font-extrabold leading-tight text-white">Rekap &amp; Laporan PKL</h1>
