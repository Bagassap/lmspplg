...
export function LengkapiFotoProfilCard() {
  return (
    <motion.div
      ...
      className="relative z-10 flex w-full max-w-3xl flex-col gap-3 rounded-[36px] bg-white p-4 shadow-[0_0_0_1px_rgba(151,125,255,0.18),0_4px_16px_rgba(0,0,0,0.06),0_20px_56px_rgba(6,0,175,0.12),0_40px_100px_rgba(0,51,255,0.07)] sm:flex-row-reverse sm:gap-4 sm:p-5"
    >
      <div
