...
const PAGE_TITLES: Record<string, [string, string]> = {
  ...
  penempatan:     ["Penempatan PKL",     "Data penempatan PKL siswa"],
  absensi:        ["Absensi",            "Data kehadiran"],
  monitoring:     ["Monitoring PKL",     "Pantau perkembangan PKL siswa"],
  rekap:          ["Rekap & Laporan",    "Rekapitulasi dan laporan data PKL"],
...
const SEARCH_ITEMS: SearchItem[] = [
  ...
  { href: "/admin/magang/penempatan",    label: "Penempatan PKL",     desc: "Data penempatan PKL",           icon: Briefcase,       roles: ["ADMIN"] },
  { href: "/admin/magang/absensi",       label: "Absensi PKL",        desc: "Data kehadiran PKL",            icon: CheckCircle2,    roles: ["ADMIN"] },
  { href: "/admin/magang/monitoring",    label: "Monitoring PKL",     desc: "Pantau perkembangan PKL",       icon: Briefcase,       roles: ["ADMIN"] },
  { href: "/admin/magang/rekap",         label: "Rekap & Laporan",    desc: "Rekapitulasi PKL",              icon: FileText,        roles: ["ADMIN"] },
  ...
  { href: "/guru/magang/absensi",        label: "Absensi PKL",        desc: "Data kehadiran PKL",            icon: CheckCircle2,    roles: ["GURU"] },
  ...
  { href: "/siswa/magang/absensi",       label: "Absensi PKL",        desc: "Data kehadiran PKL",            icon: CheckCircle2,    roles: ["SISWA"] },
...
export function Topbar({ user }: { user: UserPayload }) {
  ...
  const blueHeader = pathname.startsWith("/siswa/") || pathname === "/admin/dashboard" || pathname === "/admin/absensi-harian" || pathname === "/admin/pengumuman" || pathname === "/admin/materi" || pathname === "/admin/data-siswa" || pathname === "/admin/catatan-siswa" || pathname === "/admin/manajemen-password" || pathname === "/admin/magang/penempatan" || pathname === "/guru/dashboard" || pathname === "/guru/absensi-harian" || pathname === "/guru/pengumuman" || pathname === "/guru/materi" || pathname === "/guru/data-siswa" || pathname === "/guru/catatan-siswa" || pathname === "/guru/magang/penempatan" || pathname === "/guru/magang/absensi" || pathname === "/guru/magang/rekap" || pathname === "/guru/ujian-ukk/jadwal-soal";
      ...
      >
        <div className="flex min-w-0 items-center gap-2 lg:hidden">
          <div
            ...
            style={{ background: blueHeader ? "rgba(255,255,255,0.2)" : "#0082FB" }}
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              />
              <span className={`hidden text-sm font-medium sm:block ${blueHeader ? "text-white lg:text-gray-700 lg:dark:text-slate-200" : "text-gray-700 dark:text-slate-200"}`}>
                {user.nama.split(" ")[0]}
              </span>
              <ChevronDown
                size={13}
                className={`shrink-0 transition-transform duration-200 ${dropdownOpen ? "rotate-180" : ""} ${
                  blueHeader ? "text-white/70 lg:text-gray-400 lg:dark:text-slate-400" : "text-gray-400 dark:text-slate-400"
                }`}
              />
            </button>
