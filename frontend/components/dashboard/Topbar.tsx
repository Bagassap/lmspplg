...
export function Topbar({ user }: { user: UserPayload }) {
  ...
  const blueHeader = pathname.startsWith("/siswa/") || pathname === "/admin/dashboard" || pathname === "/admin/absensi-harian" || pathname === "/admin/pengumuman" || pathname === "/guru/dashboard" || pathname === "/guru/absensi-harian" || pathname === "/guru/pengumuman" || pathname === "/guru/materi" || pathname === "/guru/data-siswa" || pathname === "/guru/catatan-siswa" || pathname === "/guru/magang/penempatan" || pathname === "/guru/magang/absensi" || pathname === "/guru/magang/rekap" || pathname === "/guru/ujian-ukk/jadwal-soal";
